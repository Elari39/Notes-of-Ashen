...
func TestApplyEnvOverridesConfig(t *testing.T) {
	...
	if !c.AI.Enabled || c.AI.BaseURL != "https://api.example.com/v1" || c.AI.APIKey != "ai-key" || c.AI.Model != "chat-model" || c.AI.TimeoutSeconds != 45 || c.AI.FirstByteTimeoutSeconds != 60 || c.AI.StreamTimeoutSeconds != 300 || c.AI.NonStreamTimeoutSeconds != 600 {
