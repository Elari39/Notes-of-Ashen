...
export const routeLoaders = {
  ...
  resume: cacheRoute(() => import('../pages/Resume')),
  ...
  adminResumeContent: cacheRoute(() => import('../pages/admin/ResumeContent')),
...
export const Resume = lazy(routeLoaders.resume);
...
export const AdminResumeContent = lazy(routeLoaders.adminResumeContent);
